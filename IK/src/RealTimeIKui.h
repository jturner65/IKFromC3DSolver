...
public:
  ...
  std::vector<Fl_Value_Slider*> mWeights_sli;		//added by jt to handle weights window
  RealTimeIKUI();
...
private:
  ...
  static void cb_Sliders(Fl_Menu_*, void*);
	void cb_WeightSliders_i(Fl_Menu_* o, void* v);
	static void cb_WeightSliders(Fl_Menu_* o, void* v);
...
public:
  ...
  Fl_Button *mAnimModel_but;
  Fl_Button *mObjFunc_but;
private:
  void cb_mAnimModel_but_i(Fl_Button*, void*);
  static void cb_mAnimModel_but(Fl_Button*, void*);
  void cb_mObjFunc_but_i(Fl_Button* o, void* v);
  static void cb_mObjFunc_but(Fl_Button* o, void* v);
...
public:
  ...
  void CreateWeightSliderWindow();
  Fl_Double_Window *mDofSliderWindow;
  Fl_Double_Window *mWeightSliderWindow;
  void InitSliders();
  void InitWeightSliders();
  void InitControlPanel();
  void DeleteSliderWindow();
  void DeleteWeightSliderWindow();
  void Increment();
  PhowardData *mData;
};
#endif
